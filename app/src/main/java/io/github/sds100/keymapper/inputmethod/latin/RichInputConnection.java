...
import io.github.sds100.keymapper.inputmethod.compat.InputConnectionCompatUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See io.github.sds100.keymapper.inputmethod.latin.common.Constants.UnicodeSurrogate
